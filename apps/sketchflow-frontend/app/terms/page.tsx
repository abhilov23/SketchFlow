            ...
            <div className="space-y-6 p-6 rounded-xl bg-gray-900/80 backdrop-blur-sm shadow-glow hover-glow transition-all duration-300">
              <section className="space-y-4">
                ...
                <p className="text-gray-300">
                  By accessing or using SketchFlow, you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our services.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300">
                  SketchFlow provides a platform for collaborative whiteboarding. You agree to use the service only for lawful purposes and in accordance with these Terms.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300">
                  All content created on SketchFlow remains your property. By using our service, you grant us a non-exclusive, worldwide, royalty-free license to use, store, and display your content as necessary to provide the service.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300">
                  SketchFlow is not liable for any indirect, incidental, or consequential damages arising from your use of the service.
                </p>
              </section>
            </div>
